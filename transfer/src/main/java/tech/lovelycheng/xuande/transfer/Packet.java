package tech.lovelycheng.xuande.transfer;

import java.io.Serializable;

import io.netty.buffer.ByteBuf;
import lombok.Data;
import tech.lovelycheng.xuande.protocol.Serializer;
...
public class Packet implements Serializable {
    ...
    public Packet(int i, TypeCode replicate, Object o) {
    ...
    public Packet(Body body, long requestId) {
        this.header = new Header();
        this.header.requestId = requestId;
        this.body = body;
    }
